...
namespace jobWebSite.Controllers
{
    ...
    public class JobsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit( Job job,HttpPostedFileBase uploaded)
        {
            if (ModelState.IsValid)
            {
                ...
                if (uploaded != null)
                {
                    ...
                    string paths = Path.Combine(Server.MapPath("~/Uploads"), uploaded.FileName);
                    uploaded.SaveAs(paths);
                    job.JobImage = uploaded.FileName;
                }
